...
__all__ = [
    'ISpeechPhraseAlternates', 'SPEI_START_SR_STREAM',
    'DISPID_SLWPronunciations', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SDKDeleteValue', 'DISPID_SRCBookmark',
    'SpSharedRecoContext', 'SpeechMicTraining', 'SPSVerb',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCEAdaptation',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SLAddPronunciation',
    'DISPID_SPERetainedStreamOffset', 'SREPropertyNumChange',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'SWPUnknownWordUnpronounceable',
    'DISPID_SVStatus', 'DISPID_SDKEnumKeys', 'SGPronounciation',
    'DISPIDSPTSI_SelectionLength', 'SPFM_OPEN_READONLY',
    'SpeechTokenShellFolder', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechPhraseInfo', 'SPFM_CREATE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWORDPRONUNCIATION',
    'SpeechDataKeyLocation', 'SPGS_EXCLUSIVE', 'SPEI_SOUND_END',
    'DISPID_SBSSeek', 'SECFNoSpecialChars',
    'DISPID_SPANumberOfElementsInResult', 'SpeechStreamFileMode',
    'SPRST_ACTIVE_ALWAYS', 'SSSPTRelativeToStart', 'SREBookmark',
    'SSFMOpenReadWrite', 'DISPID_SRIsUISupported', 'DISPID_SBSFormat',
    'SPWF_INPUT', 'DISPID_SVVolume', 'SREStateChange',
    'DISPID_SPIAudioSizeTime', 'SpeechVoiceSpeakFlags',
    'DISPID_SPEPronunciation', 'SDTDisplayText',
    'ISpStreamFormatConverter', 'DISPID_SPAs_NewEnum',
    'SAFT11kHz16BitMono', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechObjectTokens', 'SAFTCCITT_uLaw_22kHzStereo',
    'eLEXTYPE_PRIVATE8', 'SPEI_HYPOTHESIS', 'SpeechFormatType',
    'ISpShortcut', 'SpeechEngineConfidence', 'SFTInput',
    'ISpPhoneticAlphabetConverter', 'SGRSTTTextBuffer',
    'SPGRAMMARSTATE', '__MIDL_IWinTypes_0009', 'STCRemoteServer',
    'DISPID_SRSAudioStatus', 'ISpRecoGrammar2', 'DISPID_SRAudioInput',
    'DISPID_SRRTLength', 'DISPID_SLPPhoneIds', 'DISPID_SVSPhonemeId',
    'SPSMF_UPS', 'SAFTADPCM_44kHzStereo', 'SWTAdded', 'ISpVoice',
    'eLEXTYPE_PRIVATE11', 'DISPID_SpeechPhraseElement',
    'DISPID_SPIRetainedSizeBytes', 'STSF_FlagCreate',
    'DISPID_SpeechLexiconWord', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRSRule', 'SpeechTokenKeyUI', 'SAFT16kHz8BitStereo',
    'SVSFNLPSpeakPunc', 'SPINTERFERENCE_TOOSLOW', 'SINone',
    'DISPID_SVWaitUntilDone', 'DISPID_SBSWrite', 'SPBO_PAUSE',
    'ISpeechDataKey', 'SAFT22kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechPhraseRule',
    'DISPID_SPPs_NewEnum', 'SpeechCategoryAudioOut', 'SVF_Stressed',
    'SAFT22kHz16BitStereo', 'SVSFNLPMask', 'DISPID_SGRSTWeight',
    'ISpeechPhraseReplacements', 'SGRSTTEpsilon',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpRecoResult',
    'SpeechLexiconType', 'eLEXTYPE_RESERVED8', 'SPSHORTCUTPAIRLIST',
    'SPCT_COMMAND', 'ISpLexicon', 'SPINTERFERENCE_TOOFAST',
    'ISpeechLexiconWord', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRSTType', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEVENTSOURCEINFO', 'SRCS_Enabled', 'Speech_Max_Word_Length',
    'SPPS_SuppressWord', 'DISPID_SCSBaseStream',
    'SWPKnownWordPronounceable', 'ISpXMLRecoResult', 'DISPID_SGRName',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRsAdd',
    'DISPID_SWFEExtraData', 'DISPID_SVGetAudioOutputs',
    'SAFT48kHz8BitStereo', 'ISpeechPhraseProperty',
    'DISPID_SRCEInterference', 'SITooLoud',
    'ISpeechObjectTokenCategory', 'DISPID_SDKGetStringValue',
    'SVP_10', 'SAFTGSM610_44kHzMono', 'SVESentenceBoundary',
    'SAFT22kHz8BitMono', 'DISPID_SPEsCount', 'SpNotifyTranslator',
    'DISPID_SGRsCommit', 'DISPID_SRRAlternates', 'DISPID_SRRAudio',
    'DISPID_SLWs_NewEnum', 'SAFTDefault', 'DISPID_SRRTStreamTime',
    'SP_VISEME_14', 'SVSFDefault', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRTOffsetFromStart',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechRecoResult', 'eLEXTYPE_RESERVED7', 'SPRULE',
    'SPAO_RETAIN_AUDIO', 'SPVPRI_OVER', 'SpeechAddRemoveWord',
    'SLODynamic', 'DISPID_SpeechPhraseRules', 'DISPID_SLPLangId',
    'DISPID_SRRecognizer', 'DISPID_SVSLastBookmark',
    'DISPID_SOTCGetDataKey', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_2', 'SAFT44kHz16BitStereo', 'SpeechRecognizerState',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE2', 'SITooQuiet',
    'DISPID_SRGDictationSetState', 'SpPhoneticAlphabetConverter',
    'ISpNotifySink', 'IEnumString', 'DISPID_SGRSTransitions',
    'DISPID_SPILanguageId', 'SPAUDIOBUFFERINFO', 'UINT_PTR',
    'SpeechRecoEvents', 'SpeechDiscardType',
    'DISPID_SRCEEnginePrivate', 'ISpeechPhoneConverter',
    'SAFTADPCM_44kHzMono', 'ISpMMSysAudio', 'SRADynamic',
    'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE19', 'WAVEFORMATEX',
    'ISpeechLexiconPronunciations', 'SpeechAllElements',
    'SPEI_SOUND_START', 'SP_VISEME_17', 'SGSDisabled',
    'DISPID_SAVolume', 'DISPID_SPEAudioSizeBytes', 'DISPID_SPRText',
    'SGSExclusive', 'DISPID_SOTId',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT48kHz16BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_16', 'SASStop',
    'SVP_21', 'DISPID_SWFEBlockAlign', 'DISPID_SPPsItem',
    'SAFTCCITT_uLaw_8kHzMono', 'SPEI_REQUEST_UI',
    'SVSFParseAutodetect', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoContextEvents', 'SPPS_RESERVED1',
    'DISPID_SAEventHandle', 'DISPID_SpeechVoiceEvent',
    'ISpeechAudioStatus', 'SPWORDTYPE', 'SVEStartInputStream',
    'SpeechVisemeType', 'SDTReplacement', 'SVSFIsNotXML',
    'SPDKL_CurrentConfig', 'SpResourceManager',
    'SRSInactiveWithPurge', 'SDA_Two_Trailing_Spaces',
    'SAFTADPCM_11kHzMono', 'DISPID_SPIElements', 'ISpSerializeState',
    'DISPID_SPEAudioTimeOffset', 'SLTUser',
    'SpeechRecoProfileProperties', 'eLEXTYPE_PRIVATE3',
    'SPVPRI_NORMAL', 'ISpRecognizer3', 'ISpObjectToken',
    'SPXRO_Alternates_SML', 'SREPhraseStart',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED5',
    'DISPID_SPEDisplayAttributes', 'SDKLDefaultLocation',
    'SPEI_PHRASE_START', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRCResume', 'DISPID_SRCEPhraseStart', 'SPPS_RESERVED2',
    'DISPID_SVSpeakStream', 'DISPID_SAFGetWaveFormatEx',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_RESERVED3',
    'SECHighConfidence', 'DISPID_SPPNumberOfElements',
    'SPSHORTCUTTYPE', 'SpeechRetainedAudioOptions',
    'SPEI_WORD_BOUNDARY', 'DISPID_SLGetPronunciations',
    'DISPID_SRCEPropertyStringChange', 'SpeechBookmarkOptions',
    'ISpeechRecoGrammar', 'DISPID_SDKSetStringValue',
    'DISPID_SPRulesItem', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVSCurrentStreamNumber',
    'SRTExtendableParse', 'ISpeechMMSysAudio', 'SREStreamStart',
    'SpeechLoadOption', 'SPPS_RESERVED4', 'DISPID_SASetState',
    'SPDKL_LocalMachine', 'DISPID_SVRate', 'SVP_13',
    'DISPID_SpeechAudioStatus', 'DISPID_SpeechDataKey',
    'DISPID_SRCRetainedAudio', 'SAFT44kHz16BitMono', 'DISPID_SLPType',
    'SVEAudioLevel', 'eLEXTYPE_MORPHOLOGY', 'SPCATEGORYTYPE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVP_2', 'SPSEMANTICERRORINFO',
    'DISPID_SRGIsPronounceable', 'SRAORetainAudio',
    'SPADAPTATIONRELEVANCE', 'SPGS_ENABLED',
    'ISpeechPhraseReplacement', 'ISpeechGrammarRuleStateTransitions',
    'SpPhraseInfoBuilder', 'ISpPhoneticAlphabetSelection',
    'DISPID_SAFGuid', 'ISpeechRecognizerStatus', 'DISPID_SPIRule',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCEStartStream',
    'SPCT_SUB_DICTATION', 'DISPID_SGRSAddWordTransition',
    'SPAUDIOOPTIONS', 'SSFMCreateForWrite', 'DISPID_SRCEBookmark',
    'SAFT32kHz16BitMono', 'DISPID_SpeechXMLRecoResult', 'SITooSlow',
    'DISPID_SOTsItem', 'SECLowConfidence', 'SP_VISEME_4', 'SpVoice',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRRPhraseInfo',
    'SpeechAudioProperties', 'SAFT16kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechAudioFormatGUIDWave', 'ISpeechGrammarRule',
    'DISPID_SRGCmdLoadFromObject', 'SpeechRecoContextState',
    'DISPID_SVPause', 'SREHypothesis', 'SAFT24kHz16BitStereo',
    'SpStreamFormatConverter', 'SAFT32kHz8BitMono',
    'SPEI_FALSE_RECOGNITION', 'SpeechSpecialTransitionType',
    'DISPID_SVSLastBookmarkId', 'IStream', 'DISPID_SRCEAudioLevel',
    'SPSHT_NotOverriden', 'SVP_0', 'DISPID_SRGetRecognizers',
    'ISpProperties', 'SpeechVoicePriority', 'SpeechTokenValueCLSID',
    'SPRULESTATE', 'ISpRecoContext', 'SpeechRecognitionType',
    'SRESoundStart', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPAsItem', 'SpeechRuleState', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEventInterests', 'SpeechTokenKeyFiles',
    'DISPID_SRGState', 'DISPID_SPAStartElementInResult',
    'DISPID_SPRules_NewEnum', 'SPSLMA', 'DISPID_SPIAudioSizeBytes',
    'eWORDTYPE_DELETED', 'DISPID_SVEWord', 'SRADefaultToActive',
    'DISPID_SMSSetData', 'SINoise', 'SRAONone', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRAttributes', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPCLangId', 'SpShortcut', 'eLEXTYPE_PRIVATE14',
    'SPAS_STOP', 'SAFTNonStandardFormat', 'SAFT24kHz8BitMono',
    'SPSUnknown', 'SPAS_RUN', 'SPEI_SR_BOOKMARK', 'SPSFunction',
    'ISpeechRecoResult', 'SREInterference',
    'DISPID_SPRuleNumberOfElements', 'SGLexicalNoSpecialChars',
    'DISPID_SOTCategory', 'eLEXTYPE_RESERVED4', 'SAFT16kHz8BitMono',
    'SP_VISEME_11', 'SpeechTokenKeyAttributes', 'SITooFast',
    'SPPS_Function', 'DISPID_SpeechRecoResult2',
    'DISPID_SpeechMMSysAudio', 'ISpeechResourceLoader',
    'ISpeechRecoResult2', 'IInternetSecurityMgrSite', 'SPPS_Noun',
    'DISPID_SPPFirstElement', 'ISpStreamFormat',
    'SpeechTokenIdUserLexicon', 'SPXRO_SML', 'DISPID_SFSOpen',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRRTTickCount',
    'DISPID_SRRAudioFormat', 'SAFT48kHz16BitStereo', 'DISPID_SBSRead',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SOTDisplayUI',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPRuleEngineConfidence',
    'SAFT11kHz8BitStereo', 'ISpeechMemoryStream', 'SVP_15',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRsFindRule',
    'DISPID_SGRSAddRuleTransition', 'SPWAVEFORMATTYPE',
    'DISPID_SVEPhoneme', 'Speech_StreamPos_RealTime',
    'DISPID_SDKDeleteKey', 'DISPID_SVSLastStreamNumberQueued',
    'SRTEmulated', 'SAFTADPCM_22kHzStereo', 'ISpeechCustomStream',
    'DISPID_SRStatus', 'DISPID_SPCPhoneToId', 'SRTAutopause',
    'DISPID_SAFSetWaveFormatEx', 'SAFT12kHz8BitMono', 'SLOStatic',
    'SPEVENT', 'DISPID_SRCERecognitionForOtherContext',
    'SP_VISEME_20', 'SpFileStream', 'SSTTDictation', 'SPAS_CLOSED',
    'SP_VISEME_12', 'DISPID_SOTRemoveStorageFileName', 'SRESoundEnd',
    'SAFT12kHz8BitStereo', 'DISPID_SpeechGrammarRuleStateTransition',
    'SBOPause', 'SPPS_RESERVED3', 'SVP_5',
    'DISPID_SpeechPhraseProperties', 'Speech_Max_Pron_Length',
    'DISPID_SWFEChannels', 'DISPID_SRGRules',
    'DISPID_SRGetPropertyString', 'SAFT16kHz16BitMono',
    'eLEXTYPE_PRIVATE15', 'SAFTGSM610_22kHzMono', 'ISpAudio',
    'SPEVENTENUM', 'SGSEnabled', 'SpeechRuleAttributes',
    'DISPID_SLGetWords', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechCustomStream', 'DISPID_SGRSTPropertyName',
    'SPAUDIOSTATUS', 'SRSActive', 'SSFMOpenForRead',
    'ISpPhoneConverter', 'SpLexicon', 'DISPID_SPRs_NewEnum',
    'eLEXTYPE_PRIVATE16', 'SPEI_VOICE_CHANGE', 'DISPID_SRGetFormat',
    'DISPID_SVIsUISupported', 'Speech_StreamPos_Asap',
    'DISPID_SPIStartTime', 'SRAImport', 'ISpeechPhraseElement',
    'DISPID_SVAudioOutput', 'SRCS_Disabled', 'DISPID_SABIEventBias',
    'DISPID_SVSInputWordLength', 'SPRS_INACTIVE', 'DISPID_SFSClose',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseAlternate',
    'SpeechVisemeFeature', 'DISPID_SRAudioInputStream',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRSTNextState',
    'SPEI_START_INPUT_STREAM', 'SPLOADOPTIONS',
    'DISPID_SRSetPropertyString', 'SAFTADPCM_8kHzMono',
    'SPPS_Interjection', 'DISPID_SLPSymbolic',
    'SpeechWordPronounceable', 'SAFT24kHz16BitMono', 'DISPIDSPRG',
    'SAFT8kHz16BitStereo', 'SPRST_INACTIVE', 'eLEXTYPE_PRIVATE9',
    'SAFT32kHz16BitStereo', 'DISPID_SGRSTPropertyId',
    'DISPID_SLPsItem', 'SpeechGrammarState', 'SPAR_Low',
    'SRSInactive', 'SVSFIsXML', 'STCLocalServer',
    'DISPID_SVESentenceBoundary', 'eLEXTYPE_PRIVATE6',
    'DISPID_SLWLangId', 'DISPID_SASFreeBufferSpace',
    'DISPID_SWFEAvgBytesPerSec', 'ISpEventSource', 'SPGS_DISABLED',
    'DISPID_SpeechFileStream', 'SAFTCCITT_ALaw_11kHzMono', 'SPSNoun',
    'DISPID_SPEAudioSizeTime', 'SPWT_PRONUNCIATION',
    'SPDKL_CurrentUser', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVEBookmark',
    'DISPID_SVAlertBoundary', 'SECFEmulateResult',
    'SpeechStreamSeekPositionType', 'DISPID_SRRTimes',
    'SPEI_PROPERTY_NUM_CHANGE', 'SGRSTTDictation',
    'DISPID_SVEStreamStart', 'DISPID_SPPParent', 'SPSNotOverriden',
    'SPSHT_Unknown', 'SPPS_LMA', 'SP_VISEME_0', 'SVSFUnusedFlags',
    'DISPID_SASNonBlockingIO', 'SPPS_Modifier', 'DISPID_SOTCSetId',
    'SRATopLevel', 'SVF_None', 'DISPID_SPEActualConfidence',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVP_20', 'SPEI_PHONEME',
    'DISPID_SWFEBitsPerSample', 'SAFT48kHz8BitMono', 'SPEI_MIN_TTS',
    'DISPID_SGRSTsCount', 'ISpeechVoiceStatus', 'SAFT8kHz16BitMono',
    'SP_VISEME_18', 'SPCT_SUB_COMMAND', 'SFTSREngine',
    'SDTAlternates', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRCERequestUI', 'SPVPRI_ALERT', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRIsShared', 'DISPID_SVSInputWordPosition', 'SASClosed',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE17', 'DISPID_SRCRecognizer',
    'eLEXTYPE_LETTERTOSOUND', 'ISpNotifySource',
    'DISPID_SRCreateRecoContext', 'DISPIDSPTSI_ActiveLength',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_16', 'SAFT8kHz8BitMono',
    'SPEI_RECO_STATE_CHANGE', 'SpeechRegistryUserRoot',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPIAudioStreamPosition', 'SAFT11kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechXMLRecoResult', 'SAFTADPCM_22kHzMono',
    'DISPID_SRCESoundEnd', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVEEnginePrivate',
    'SSSPTRelativeToEnd', 'DISPID_SPRuleName',
    'DISPID_SLPPartOfSpeech', 'SVP_11', 'SPWF_SRENGINE',
    'SVF_Emphasis', 'DISPID_SPRuleConfidence', 'ISpeechBaseStream',
    'DISPID_SLGetGenerationChange', 'SPCT_SLEEP',
    'DISPID_SRDisplayUI', 'SpAudioFormat', 'ISpRecoGrammar',
    'SWPUnknownWordPronounceable', 'DISPID_SMSADeviceId',
    'DISPID_SASCurrentDevicePosition', 'SPWORD', 'ISpeechPhraseRules',
    'DISPID_SpeechAudioBufferInfo', 'SpeechCategoryRecognizers',
    'eWORDTYPE_ADDED', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SpeechGrammarRuleState',
    'SpeechRunState', 'DISPID_SpeechLexiconProns', 'SPCS_DISABLED',
    'DISPID_SPEEngineConfidence', 'STSF_LocalAppData',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCCmdMaxAlternates', 'SREAllEvents', 'SpeechAudioState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechPropertyResourceUsage',
    'SPEI_TTS_PRIVATE', 'SVEVoiceChange', 'eLEXTYPE_PRIVATE12',
    'ISpDataKey', 'DISPID_SPEDisplayText', 'SDKLCurrentUser',
    'SPTEXTSELECTIONINFO', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_RECOGNITION', 'SpeechCategoryPhoneConverters',
    'SGDSActiveUserDelimited', 'ISpeechRecoResultTimes',
    'SP_VISEME_5', 'DISPIDSPTSI_ActiveOffset', 'SVSFParseSapi',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_NotOverriden',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SABIBufferSize',
    'SPVPRIORITY', 'DISPID_SpeechAudioFormat', 'DISPID_SMSAMMHandle',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPIGetText', 'DISPIDSPTSI',
    'ISequentialStream', 'SPFM_NUM_MODES', 'SpeechAudioFormatType',
    'SPBO_AHEAD', 'SVP_6', 'SpeechCategoryRecoProfiles',
    'SP_VISEME_3', 'SPBOOKMARKOPTIONS', 'SpeechVoiceEvents',
    'DISPID_SDKGetlongValue', 'SRSActiveAlways', 'SVSFlagsAsync',
    'SPCONTEXTSTATE', 'SPPHRASEREPLACEMENT', 'SpeechGrammarWordType',
    'SREPropertyStringChange', 'SPEI_RESERVED6',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRGRecoContext', 'SpUnCompressedLexicon', 'SVP_1',
    'DISPID_SGRInitialState', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTCCITT_ALaw_8kHzMono', 'SWTDeleted', 'SVEWordBoundary',
    'SPSEMANTICFORMAT', 'DISPID_SVEventInterests', 'SVSFIsFilename',
    'SRTSMLTimeout', 'SPPROPERTYINFO', 'SRTStandard',
    'SSTTTextBuffer', 'DISPID_SRGDictationUnload',
    'SRERecoOtherContext', 'SRARoot', 'DISPID_SpeechLexicon',
    'DISPID_SPCIdToPhone', 'DISPID_SLRemovePronunciation',
    'SPSHORTCUTPAIR', 'SVP_7', 'ISpStream', 'ISpeechWaveFormatEx',
    'DISPID_SDKSetLongValue', 'SAFT32kHz8BitStereo',
    'DISPID_SRRSetTextFeedback', 'SREFalseRecognition',
    'DISPID_SpeechPhraseBuilder', 'SP_VISEME_1', 'ISpRecoCategory',
    'DISPID_SRCPause', 'DISPID_SVSpeak', 'DISPID_SPRuleParent',
    'DISPID_SPPId', 'DISPID_SPIGetDisplayAttributes', 'SPVISEMES',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechPhraseRule',
    'DISPID_SpeechRecognizerStatus', 'SpeechVoiceCategoryTTSRate',
    'SVSFParseMask', 'SPAR_Medium', 'DISPID_SpeechRecoResultTimes',
    'SpMemoryStream', 'ISpRecoContext2', 'DISPID_SDKEnumValues',
    'SPLO_STATIC', 'SGRSTTWord', 'SPVOICESTATUS',
    'DISPID_SpeechGrammarRule', 'DISPID_SRProfile',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_INTERFERENCE',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRAddResource',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRId', 'ISpeechPhraseElements',
    'DISPID_SOTRemove', 'DISPID_SABufferInfo', 'STSF_AppData',
    'SPAR_Unknown', 'DISPID_SRCState', 'SPINTERFERENCE',
    'SECFDefault', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SGRSTs_NewEnum', 'SpPhoneConverter', 'DISPID_SPAsCount',
    'SDA_No_Trailing_Space', 'SGDisplay', 'SPCT_DICTATION',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRsItem', 'DISPID_SVPriority', 'DISPID_SpeechAudio',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVGetVoices',
    'DISPID_SOTCId', 'SpeechCategoryAppLexicons',
    'DISPID_SRGDictationLoad', 'ISpeechLexicon',
    'SAFTNoAssignedFormat', 'DISPID_SAFType',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRuleId',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpPhraseAlt',
    'DISPID_SRRSaveToMemory', 'ISpeechRecoContext',
    'DISPID_SOTDataKey', 'SECFIgnoreCase',
    'DISPID_SRGSetTextSelection', 'SDTProperty',
    'DISPID_SPISaveToMemory', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVSFVoiceMask', 'SRAExport', 'SAFT12kHz16BitMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_10', 'SPRST_NUM_STATES',
    'SSTTWildcard', 'SPEI_UNDEFINED', 'SPRECOGNIZERSTATUS',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', '_ISpeechVoiceEvents',
    'SGLexical', 'SGDSInactive', 'SPBO_TIME_UNITS',
    'SSSPTRelativeToCurrentPosition', 'SPSHT_OTHER', 'ISpeechVoice',
    'SpObjectTokenCategory', 'SPDKL_DefaultLocation',
    'DISPID_SVSVisemeId', 'SAFTText', 'DISPID_SLPsCount',
    'DISPID_SRGCmdLoadFromResource', 'SGRSTTRule',
    'ISpeechPhraseProperties', 'SECNormalConfidence', 'SPRST_ACTIVE',
    'SBONone', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVSLastResult', 'SVEPrivate', 'SPPS_Noncontent',
    'ISpEventSink', 'SGRSTTWildcard', 'DISPID_SPPConfidence',
    'SPPHRASE', 'SSFMCreate', 'DISPID_SPPsCount', 'SPEI_MIN_SR',
    'SVSFPersistXML', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFT44kHz8BitStereo', 'SPXMLRESULTOPTIONS', 'SDTPronunciation',
    'SGDSActive', 'DISPID_SVAudioOutputStream', 'SpSharedRecognizer',
    'ISpObjectWithToken', 'SpeechPropertyResponseSpeed',
    'DISPID_SOTGetDescription', 'DISPID_SPERetainedSizeBytes',
    'SpeechWordType', 'DISPID_SVSkip', 'DISPID_SRState',
    'SP_VISEME_8', 'DISPID_SPACommit', 'SREAdaptation',
    'DISPID_SpeechObjectToken', 'DISPID_SVEStreamEnd',
    'STSF_CommonAppData', 'DISPID_SAStatus', 'SECFIgnoreWidth',
    'eLEXTYPE_RESERVED6', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPRsCount', 'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_21',
    'DISPID_SVGetProfiles', 'SLTApp', 'SpStream', 'SPDATAKEYLOCATION',
    '_ISpeechRecoContextEvents',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPPValue',
    'SPWORDPRONOUNCEABLE', '_SPAUDIOSTATE', 'DISPID_SRGId',
    'DISPID_SpeechPhraseReplacement', 'SPSSuppressWord',
    'SpeechUserTraining', 'DISPID_SABufferNotifySize',
    'DISPID_SPPChildren', 'eLEXTYPE_APP', 'DISPID_SADefaultFormat',
    'SPRECORESULTTIMES', 'SPEI_RESERVED2', 'eLEXTYPE_VENDORLEXICON',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SLWType', 'SAFT44kHz8BitMono', 'SpeechPartOfSpeech',
    'SPBO_NONE', 'SPAS_PAUSE', 'SAFTCCITT_ALaw_22kHzMono',
    'SPFM_OPEN_READWRITE', 'STCAll', 'Speech_Default_Weight',
    'DISPID_SRCESoundStart', 'SPINTERFERENCE_TOOQUIET',
    'SpeechGrammarTagDictation', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRuleChildren', 'DISPID_SLWsItem',
    'SGDSActiveWithAutoPause', 'tagSPPROPERTYINFO',
    'SAFT12kHz16BitStereo', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRCCreateResultFromMemory', 'SAFT8kHz8BitStereo',
    'ISpeechObjectTokens', 'ISpObjectTokenCategory',
    'SpeechCategoryAudioIn', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechVoice', 'DISPID_SpeechBaseStream', 'SVPAlert',
    'DISPID_SGRAddState', 'SVEBookmark', 'DISPID_SVVoice',
    'tagSTATSTG', 'DISPID_SMSALineId', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCRetainedAudioFormat', 'SpeechCategoryVoices',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRCSetAdaptationData', 'SVPOver', 'SpMMAudioEnum',
    'SPSTREAMFORMATTYPE', 'SpCompressedLexicon',
    'SPINTERFERENCE_NONE', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_PRIVATE7', 'ISpeechGrammarRuleStateTransition',
    'ISpeechFileStream', 'DISPID_SPEsItem',
    'DISPID_SREmulateRecognition', 'ISpeechTextSelectionInformation',
    'DISPID_SLWWord', 'SPAO_NONE', 'SPGRAMMARWORDTYPE', 'SPPS_Verb',
    'SREPrivate', 'SPFILEMODE', 'eLEXTYPE_PRIVATE1',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVResume', 'SPSModifier',
    'SAFTCCITT_ALaw_11kHzStereo', 'SREAudioLevel',
    'DISPID_SVSInputSentencePosition', 'DISPID_SMSGetData',
    'SRAInterpreter', 'SP_VISEME_6',
    'DISPID_SRCERecognizerStateChange', 'SPPARTOFSPEECH', 'SVPNormal',
    'SVP_4', 'ISpeechAudio', 'SpInProcRecoContext', 'DISPID_SPPName',
    'SpMMAudioIn', 'SRSEDone', 'SVSFParseSsml', 'SPAUDIOSTATE',
    'SDA_One_Trailing_Space', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SLGenerationId', 'ISpeechGrammarRuleState',
    'IInternetSecurityManager', 'SPWORDLIST',
    'DISPID_SpeechPhraseAlternates', 'SpWaveFormatEx', 'ISpPhrase',
    'SPAR_High', 'SASPause', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPRsItem', 'SpeechDisplayAttributes', 'SVP_18',
    'SP_VISEME_7', 'SPCS_ENABLED', 'SVP_17', 'ISpeechObjectToken',
    'SpeechAudioVolume', 'DISPID_SVSRunningState', 'SREStreamEnd',
    'SDTAll', 'SP_VISEME_13', 'STCInprocServer', 'DISPID_SVEViseme',
    'DISPID_SRRGetXMLResult', 'SPEI_VISEME',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTs_NewEnum',
    'SPEI_END_SR_STREAM', 'DISPID_SPIReplacements',
    'SpInprocRecognizer', 'LONG_PTR', 'DISPID_SGRSTPropertyValue',
    'SPPS_Unknown', 'SVP_14', 'SPEI_MAX_SR', 'SpeechInterference',
    'SAFT11kHz16BitStereo', 'DISPID_SRSClsidEngine',
    'DISPID_SGRSTRule', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SABIMinNotification', 'SPLO_DYNAMIC',
    'SpNullPhoneConverter', 'ISpeechLexiconPronunciation',
    'DISPID_SPRulesCount', 'ISpResourceManager',
    'SpeechEngineProperties', 'DISPID_SDKGetBinaryValue',
    'SPWT_LEXICAL', 'SINoSignal', 'SPEI_MAX_TTS',
    'DISPID_SPIGrammarId', 'SP_VISEME_19', 'DISPID_SGRs_NewEnum',
    'STCInprocHandler', 'SAFT24kHz8BitStereo', 'SDTAudio',
    'DISPID_SRCVoice', 'SVP_8', 'DISPID_SPRNumberOfElements',
    'SVEPhoneme', 'SPSERIALIZEDPHRASE', 'SPEI_ADAPTATION',
    'ISpeechPhraseInfo', 'SpMMAudioOut', 'SPWT_DISPLAY', 'SVP_3',
    'DISPID_SDKOpenKey', 'SPBINARYGRAMMAR', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_9', 'ISpeechAudioFormat', 'SAFTGSM610_11kHzMono',
    'SDTRule', 'DISPID_SOTMatchesAttributes', 'DISPID_SDKCreateKey',
    'DISPID_SPARecoResult', 'DISPID_SGRClear',
    'DISPID_SPELexicalForm', 'DISPID_SOTSetId', 'ISpNotifyTranslator',
    'SVP_19', 'SDTLexicalForm', 'DISPID_SPEs_NewEnum',
    'SDKLCurrentConfig', 'DISPID_SOTGetAttribute', 'ISpRecognizer2',
    'DISPID_SGRsCount', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechRecognizer', 'SPSInterjection', 'SPPHRASERULE',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SDKSetBinaryValue',
    'SPEI_SR_PRIVATE', 'SP_VISEME_15', 'ISpeechRecognizer', 'SASRun',
    'DISPID_SOTsCount', 'DISPID_SLPs_NewEnum',
    'SpeechRegistryLocalMachineRoot', 'SpeechDictationTopicSpelling',
    'DISPID_SOTGetStorageFileName', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGReset', 'SPINTERFERENCE_TOOLOUD', 'SpCustomStream',
    'ISpGrammarBuilder', 'DISPID_SpeechPhraseProperty',
    'ISpeechRecoResultDispatch', 'SVEViseme', 'IEnumSpObjectTokens',
    'DISPID_SPIEngineId', 'ISpeechPhraseAlternate',
    'DISPID_SOTIsUISupported', 'DISPID_SGRsDynamic',
    'SPPHRASEPROPERTY', 'SRSEIsSpeaking', 'SVEAllEvents',
    'DISPID_SGRSTsItem', 'SpeechGrammarTagWildcard',
    'DISPID_SASState', 'SPEI_RESERVED1', 'SPPHRASEELEMENT',
    'SpObjectToken', 'SRTReSent', 'DISPID_SVEVoiceChange',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCERecognition',
    'DISPID_SRRSpeakAudio', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPIProperties',
    'DISPID_SOTCDefault', 'SRERequestUI', 'DISPID_SRCVoicePurgeEvent',
    'SAFTExtendedAudioFormat', 'DISPID_SLWsCount',
    'DISPID_SRGetPropertyNumber', 'SVP_9',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpTextSelectionInformation', 'SpeechTokenContext',
    'DISPID_SPRFirstElement', 'SPRECOSTATE', 'SPSERIALIZEDRESULT',
    '_RemotableHandle', 'SDKLLocalMachine',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRRecoContext',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechLexiconWords',
    'SVP_12', 'eLEXTYPE_PRIVATE10', 'SPLEXICONTYPE',
    'DISPID_SPAPhraseInfo', 'ISpeechGrammarRules',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRGCommit',
    'ISpeechAudioBufferInfo', 'DISPID_SRGCmdSetRuleState',
    'SECFIgnoreKanaType', 'ISpeechLexiconWords',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRCRequestedUIType', 'SVEEndInputStream',
    'SPINTERFERENCE_NOISE', 'DISPID_SRCEEndStream', 'ISpRecognizer',
    'SRERecognition', 'DISPID_SpeechGrammarRules', 'SPRS_ACTIVE'
]

_check_version('1.1.14', 1721979031.518805)
