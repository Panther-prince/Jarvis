...
__all__ = [
    'eLEXTYPE_PRIVATE16', 'SVP_2', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVAlertBoundary', 'SpCompressedLexicon', 'SPCATEGORYTYPE',
    'SGRSTTDictation', 'SGSExclusive', 'SAFTADPCM_11kHzStereo',
    'SPVPRI_ALERT', 'SpeechSpecialTransitionType',
    'DISPID_SVPriority', 'SpeechRecoProfileProperties',
    'SPEI_HYPOTHESIS', 'DISPID_SPIStartTime', 'SVP_21',
    'ISpeechPhraseAlternate', 'DISPID_SRCVoice', 'SPRULE',
    'DISPID_SDKOpenKey', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVSpeakStream', 'DISPID_SRGetFormat',
    'DISPID_SRCESoundEnd', 'DISPID_SRRSaveToMemory',
    'SDA_One_Trailing_Space', 'SPINTERFERENCE',
    'SPEI_FALSE_RECOGNITION', 'SPFM_NUM_MODES',
    'DISPID_SPERetainedSizeBytes', 'SPAS_CLOSED',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLWsItem',
    'SECFIgnoreWidth', 'SP_VISEME_4', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SFSOpen', 'DISPID_SRRTLength', 'SAFT8kHz8BitStereo',
    'SVPAlert', 'DISPID_SpeechPhoneConverter',
    'ISpPhoneticAlphabetSelection', 'SPDKL_LocalMachine',
    'DISPID_SRSAudioStatus', 'SpeechCategoryAudioOut',
    'DISPID_SVWaitUntilDone', 'SECFIgnoreCase',
    'DISPID_SVAudioOutput', 'SP_VISEME_2',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPCPhoneToId', 'SPEI_MIN_TTS', 'SITooQuiet',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPACommit',
    'DISPID_SCSBaseStream', 'SpeechTokenShellFolder',
    'SpInprocRecognizer', 'SpeechRecognizerState', 'ISpEventSource',
    'DISPID_SRIsShared', 'ISpRecoContext2', 'SPPHRASERULE',
    'DISPID_SRRTStreamTime', 'SAFT11kHz8BitMono',
    'DISPID_SRCRetainedAudio', 'DISPID_SVVoice', 'SVSFNLPMask',
    'DISPID_SPRuleParent', 'SP_VISEME_0', 'DISPID_SVEventInterests',
    'DISPID_SRRTOffsetFromStart', 'SP_VISEME_16',
    'SpeechCategoryAudioIn', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVSLastStreamNumberQueued',
    'SPAUDIOBUFFERINFO', 'DISPID_SAStatus',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPCT_COMMAND',
    'SDA_No_Trailing_Space', 'ISpGrammarBuilder', 'SASRun',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SLGetPronunciations', 'DISPID_SRSetPropertyNumber',
    'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE9', 'ISpeechGrammarRules',
    'SPPS_Noun', 'SSFMOpenReadWrite', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpMMAudioOut', 'SDTProperty',
    'DISPID_SPPBRestorePhraseFromMemory', 'SP_VISEME_1',
    'SpPhoneticAlphabetConverter', 'ISpSerializeState',
    'SVF_Stressed', 'SVP_15', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPPsCount', 'DISPID_SASState', 'SpInProcRecoContext',
    'ISpeechDataKey', 'SpeechFormatType',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPPS_RESERVED4', 'SREHypothesis',
    'SREAllEvents', 'SpShortcut', 'SPSHORTCUTPAIRLIST',
    'SP_VISEME_13', 'DISPID_SpeechObjectTokenCategory', 'SINoise',
    'ISpeechVoice', 'SRERecognition', 'DISPID_SGRAddResource',
    'SPGRAMMARSTATE', 'SAFT8kHz8BitMono',
    'DISPID_SpeechXMLRecoResult', 'ISpShortcut', 'SDTPronunciation',
    'SPPHRASE', 'DISPID_SPEsCount', 'SASStop', 'SPWT_PRONUNCIATION',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SVSyncronousSpeakTimeout', 'SVEVoiceChange',
    'SVSFlagsAsync', 'SECLowConfidence', 'DISPID_SPPName',
    'SREAudioLevel', 'DISPID_SRCEEnginePrivate', 'SDTAll',
    'DISPID_SGRSTPropertyName', 'DISPID_SOTIsUISupported',
    'DISPID_SPIRetainedSizeBytes', 'SP_VISEME_20', 'SPSHT_OTHER',
    'SECFNoSpecialChars', 'DISPID_SBSRead', 'SAFT48kHz16BitMono',
    'DISPID_SPPNumberOfElements', 'DISPID_SLPsItem',
    'SPBINARYGRAMMAR', 'DISPID_SpeechDataKey',
    'DISPID_SRCEInterference', 'DISPID_SVDisplayUI',
    'ISpObjectTokenCategory', 'SP_VISEME_10', 'ISpNotifySource',
    'DISPID_SpeechLexiconWords', 'SPEI_TTS_AUDIO_LEVEL', 'SVP_18',
    'SDA_Two_Trailing_Spaces', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_8kHzMono', 'SAFT11kHz16BitMono',
    'DISPID_SOTCEnumerateTokens', 'SLODynamic',
    'DISPID_SGRSTPropertyId', 'SPSEMANTICERRORINFO',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpWaveFormatEx',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRInitialState',
    'SPINTERFERENCE_NONE', 'SP_VISEME_21', 'SVSFDefault',
    'SPSHORTCUTPAIR', 'DISPID_SVSkip', 'SAFT11kHz8BitStereo',
    'ISpeechRecognizerStatus', 'SAFT32kHz16BitMono', 'SRSEIsSpeaking',
    'SPVPRI_OVER', 'SVF_Emphasis', 'tagSTATSTG', 'SRAORetainAudio',
    'SRESoundStart', 'SAFTADPCM_44kHzStereo', 'DISPID_SRRTTickCount',
    'SpTextSelectionInformation', 'SVSFNLPSpeakPunc',
    'DISPID_SLGetGenerationChange', 'SpeechRunState',
    'ISpeechGrammarRuleState', 'SPEI_SR_PRIVATE',
    'DISPID_SRGRecoContext', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechResourceLoader',
    'SpeechPartOfSpeech', 'DISPID_SOTCreateInstance', 'ISpDataKey',
    'Speech_StreamPos_Asap', 'DISPID_SPRs_NewEnum', 'SGDisplay',
    'SAFT24kHz16BitMono', 'DISPID_SRCResume', 'IEnumSpObjectTokens',
    'DISPID_SpeechPhraseReplacement', 'SVP_16',
    'DISPID_SpeechObjectTokens', 'SpeechVoicePriority',
    'SPPHRASEELEMENT', 'DISPID_SpeechAudioFormat', 'SPWT_LEXICAL',
    'SECHighConfidence', 'DISPID_SVSInputSentenceLength',
    'SpStreamFormatConverter', 'SRERecoOtherContext',
    'SSSPTRelativeToStart', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTCGetDataKey', 'DISPID_SABIEventBias',
    'SpeechStreamSeekPositionType', 'DISPID_SVEPhoneme',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechRetainedAudioOptions',
    'SPLOADOPTIONS', 'DISPID_SpeechRecoResultTimes', 'ISpProperties',
    'DISPID_SpeechGrammarRuleStateTransition', 'SP_VISEME_9',
    'SPFILEMODE', 'SREPhraseStart', 'SREPropertyStringChange',
    'eLEXTYPE_PRIVATE8', 'SWTDeleted', 'DISPID_SGRSTsCount',
    'SPWF_INPUT', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPRFirstElement',
    'SP_VISEME_7', 'SRSActive', 'SINone', 'DISPID_SRCEHypothesis',
    'SpeechVoiceSpeakFlags', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SBSSeek', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPIAudioSizeTime', 'SpeechGrammarTagWildcard', 'SPAR_Low',
    'ISpeechCustomStream', 'ISpNotifySink',
    'DISPID_SPEAudioStreamOffset', 'SP_VISEME_15',
    'DISPID_SVAudioOutputStream', 'DISPID_SDKSetStringValue',
    'SVSFParseSsml', 'DISPID_SDKEnumValues', 'ISpeechAudioFormat',
    'SPEI_START_SR_STREAM', 'ISpeechPhraseReplacement', 'SGLexical',
    'DISPID_SBSWrite', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_RESERVED4',
    'ISpMMSysAudio', 'SAFT8kHz16BitStereo', 'eLEXTYPE_USER',
    'SPWORDLIST', 'SGDSInactive', 'ISpeechObjectTokenCategory',
    'SpeechAudioFormatGUIDText', '_SPAUDIOSTATE',
    'DISPID_SRRAudioFormat', 'SRTReSent', 'SECNormalConfidence',
    'ISpeechFileStream', 'SAFTADPCM_8kHzStereo', 'DISPID_SLPLangId',
    'DISPID_SGRsCommit', 'DISPID_SVEViseme', 'SAFTDefault',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPIEnginePrivateData', '_ISpeechRecoContextEvents',
    'DISPID_SpeechRecoResult', 'SPEI_RESERVED6',
    'ISpeechGrammarRuleStateTransition', 'SPRST_INACTIVE',
    'SREStreamStart', 'DISPID_SPPConfidence',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVSVisemeId',
    '_RemotableHandle', 'DISPID_SRGetPropertyString',
    'ISpeechPhoneConverter', 'SVSFPurgeBeforeSpeak',
    'SREPropertyNumChange', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRRecognizer', 'SAFT11kHz16BitStereo', 'SPEI_VISEME',
    'SpeechVoiceSkipTypeSentence', 'ISpRecognizer',
    'DISPID_SPRules_NewEnum', 'SPPS_Unknown', 'ISpeechWaveFormatEx',
    'SpMemoryStream', 'SPRST_NUM_STATES', 'DISPID_SASNonBlockingIO',
    'SPRST_ACTIVE', 'DISPID_SDKSetLongValue',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechGrammarRules',
    'IInternetSecurityMgrSite', 'SPFM_CREATE', 'SPWAVEFORMATTYPE',
    'DISPID_SRCESoundStart', 'DISPID_SDKCreateKey',
    'DISPID_SRDisplayUI', 'DISPID_SVEEnginePrivate', 'SREStateChange',
    'SDKLDefaultLocation', 'SPEI_VOICE_CHANGE', 'DISPID_SPAsItem',
    'SAFT24kHz8BitMono', 'SECFIgnoreKanaType', 'SAFTADPCM_11kHzMono',
    'SECFDefault', 'DISPID_SDKDeleteValue', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE14', 'SpVoice',
    'DISPID_SVStatus', 'SRSActiveAlways', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRState', 'ISpeechPhraseRule', 'SPAR_Medium',
    'SVSFIsFilename', 'SDKLCurrentUser', 'SRARoot',
    'SpeechPropertyComplexResponseSpeed', 'SAFT44kHz16BitStereo',
    'SPPARTOFSPEECH', 'DISPID_SWFEExtraData', 'SP_VISEME_5',
    'SPSERIALIZEDRESULT', 'SVP_3', 'SPPHRASEPROPERTY', 'SAFTText',
    'SAFTCCITT_uLaw_8kHzStereo', 'SP_VISEME_11',
    'DISPID_SPILanguageId', 'SPEI_RECOGNITION', 'ISpEventSink',
    'DISPID_SpeechPhraseProperties', 'SAFT24kHz16BitStereo',
    'DISPID_SGRsFindRule', 'SPEI_MAX_SR', 'DISPID_SPAsCount',
    'SPSUnknown', 'SP_VISEME_18', 'SpeechRecoContextState',
    'SPDKL_CurrentUser', 'SGRSTTRule', 'SpeechAddRemoveWord',
    'STSF_AppData', 'DISPID_SPRuleEngineConfidence', 'DISPID_SRGId',
    'SpeechRecognitionType', 'SVP_17', 'SAFTCCITT_uLaw_8kHzMono',
    'SITooLoud', 'DISPID_SpeechPhraseElement',
    'DISPID_SRGSetTextSelection', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRCPause', 'DISPID_SRRSetTextFeedback',
    'DISPID_SOTGetStorageFileName', 'SPSEMANTICFORMAT',
    'ISpeechVoiceStatus', 'DISPID_SRCRecognizer',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCEStartStream',
    'DISPID_SPARecoResult', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPRulesItem',
    'SpeechCategoryAppLexicons', 'IInternetSecurityManager',
    'DISPID_SPISaveToMemory', 'DISPID_SGRSTType',
    'DISPID_SPIAudioStreamPosition', 'SAFTADPCM_44kHzMono',
    'STSF_LocalAppData', 'DISPID_SMSADeviceId', 'SpeechAudioState',
    'SAFTNoAssignedFormat', 'SAFT32kHz8BitMono', 'SPBO_TIME_UNITS',
    'SpeechCategoryPhoneConverters', 'SpeechTokenKeyFiles',
    'ISpRecoGrammar2', 'SpeechRecoEvents', 'DISPID_SRRSpeakAudio',
    'SAFT32kHz16BitStereo', 'eLEXTYPE_PRIVATE1', 'SVP_20',
    'Speech_StreamPos_RealTime', 'DISPID_SRRPhraseInfo',
    'SpeechUserTraining', 'SpeechEngineProperties',
    'DISPID_SBSFormat', 'SPSLMA', 'DISPID_SLRemovePronunciation',
    'SPPS_Interjection', 'DISPID_SOTRemove', 'ISpObjectWithToken',
    'SPCS_ENABLED', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SADefaultFormat', 'SPAS_RUN', 'SPEI_TTS_BOOKMARK',
    'SVEViseme', 'eWORDTYPE_DELETED',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGIsPronounceable',
    'DISPID_SGRName', 'SP_VISEME_3', 'SPRECOCONTEXTSTATUS',
    'DISPID_SMSSetData', 'SSFMCreateForWrite', 'ISpXMLRecoResult',
    'DISPID_SPEAudioTimeOffset', 'SPWF_SRENGINE', 'DISPID_SPIRule',
    'DISPID_SPRulesCount', 'DISPID_SASCurrentDevicePosition',
    'SPGRAMMARWORDTYPE', 'SPSSuppressWord', 'DISPID_SPAPhraseInfo',
    'SPSModifier', 'SPSNotOverriden', 'DISPID_SRSClsidEngine',
    'DISPID_SRIsUISupported', 'SLOStatic', 'SPSNoun',
    'DISPID_SpeechPhraseReplacements', 'SPAUDIOSTATUS',
    'SPEI_SOUND_END', 'ISpeechPhraseElement', 'SPEI_SR_BOOKMARK',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechPhraseAlternate',
    'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE5', 'DISPID_SLPs_NewEnum',
    'DISPID_SPERetainedStreamOffset', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechLoadOption', 'ISpeechPhraseAlternates',
    'DISPID_SVSLastBookmarkId', 'SpObjectToken',
    'SpeechEmulationCompareFlags', 'DISPID_SPIEngineId',
    'SAFT48kHz8BitMono', 'ISpeechPhraseInfoBuilder',
    'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCreateRecoContext', 'SFTInput',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechAudioStatus',
    'DISPID_SPPFirstElement', 'tagSPTEXTSELECTIONINFO', 'SASClosed',
    'ISpRecoResult', 'DISPID_SPRuleFirstElement',
    'eLEXTYPE_VENDORLEXICON', 'SPGS_DISABLED',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCBookmark',
    'DISPID_SRCEBookmark', 'SAFT12kHz8BitMono',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPEs_NewEnum',
    'tagSPPROPERTYINFO', 'DISPID_SGRsAdd', 'SPEI_MAX_TTS',
    'DISPID_SRCState', 'DISPID_SpeechRecoContext', 'SpFileStream',
    'ISpStreamFormat', 'DISPID_SGRsCommitAndSave',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRsItem',
    'SVEWordBoundary', 'DISPID_SGRs_NewEnum', 'SPCT_SLEEP',
    'SAFTCCITT_ALaw_44kHzMono', 'eLEXTYPE_PRIVATE15',
    'SPFM_CREATE_ALWAYS', 'SpeechGrammarWordType',
    'ISpPhoneConverter', 'ISpRecognizer2',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SFSClose',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPRuleConfidence',
    'SRERequestUI', 'SpeechCategoryRecognizers',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SVEStreamEnd',
    'eLEXTYPE_PRIVATE20', 'DISPID_SpeechPhraseRule',
    'SpNotifyTranslator', 'SpeechAudioProperties', 'SVP_4',
    'DISPID_SGRSTPropertyValue', 'SAFT44kHz16BitMono',
    'SpeechVoiceEvents', 'SREBookmark', 'SpeechAudioVolume',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSTNextState', 'SLTApp',
    'SWTAdded', 'SVEAudioLevel', 'SDTAudio', 'SGRSTTWord', 'ISpVoice',
    'DISPID_SVSpeakCompleteEvent', 'SPTEXTSELECTIONINFO',
    'SPGS_EXCLUSIVE', 'STSF_FlagCreate', 'SVPNormal',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechAudio',
    'DISPID_SWFEFormatTag', 'DISPID_SPIGetText',
    'ISpeechPhraseProperties', 'DISPID_SpeechPhraseRules',
    'SAFT12kHz16BitStereo', 'DISPID_SOTsCount',
    'DISPID_SpeechMMSysAudio', 'SVEAllEvents', 'DISPID_SOTId',
    'ISpeechAudioStatus', 'ISpeechRecognizer', 'SAFT12kHz16BitMono',
    'ISpLexicon', 'SPVPRIORITY', 'SPEVENTSOURCEINFO',
    'SpCustomStream', 'eLEXTYPE_RESERVED6', 'SBONone',
    'eLEXTYPE_PRIVATE17', 'SVP_14', 'SpeechMicTraining',
    'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_TOOLOUD', 'SVP_5',
    'DISPID_SGRSTRule', 'SAFTCCITT_uLaw_11kHzStereo', 'SITooFast',
    'SPXRO_Alternates_SML', 'SpResourceManager',
    'DISPID_SGRSTransitions', 'SRTSMLTimeout', 'ISpeechPhraseInfo',
    'eLEXTYPE_PRIVATE3', 'ISpStream', 'SGSEnabled',
    'DISPID_SVEVoiceChange', 'DISPID_SPEsItem', 'SPRS_ACTIVE',
    'DISPID_SPEActualConfidence', 'SPEI_RESERVED5',
    'SGDSActiveWithAutoPause', 'SRSEDone', 'SFTSREngine',
    'SpeechPropertyNormalConfidenceThreshold', 'SPVOICESTATUS',
    'DISPID_SpeechFileStream', 'DISPID_SRRAlternates',
    'ISpeechMMSysAudio', 'SPPHRASEREPLACEMENT', 'ISpResourceManager',
    'DISPID_SDKDeleteKey', 'STCRemoteServer',
    'DISPID_SRSetPropertyString', 'SpeechInterference', 'SASPause',
    'DISPID_SDKGetStringValue', 'SGSDisabled',
    'DISPID_SVESentenceBoundary', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRRRecoContext', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseElements', 'DISPID_SVSPhonemeId', 'SPAO_NONE',
    'SpeechLexiconType', 'SPGS_ENABLED', 'eLEXTYPE_MORPHOLOGY',
    'SRSInactive', 'DISPID_SASFreeBufferSpace', 'DISPID_SRGRules',
    'SPEI_ADAPTATION', 'SpeechPropertyLowConfidenceThreshold',
    'SpUnCompressedLexicon', 'SPWORDTYPE', 'SPEI_SENTENCE_BOUNDARY',
    'SpAudioFormat', 'SRTExtendableParse', 'DISPID_SPIProperties',
    'DISPID_SLWs_NewEnum', 'SVSFParseSapi', 'SAFT22kHz8BitStereo',
    'SDTDisplayText', 'SPSHT_NotOverriden', 'ISpeechLexiconWord',
    'SDTReplacement', 'SVP_11', 'DISPID_SpeechLexiconProns',
    'DISPID_SWFESamplesPerSec', 'DISPID_SABIMinNotification',
    'DISPID_SVEStreamStart', 'SVEStartInputStream', 'SPPS_Modifier',
    'SECFEmulateResult', 'SPEI_RESERVED3', 'SAFT48kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_17', 'SPPS_RESERVED1',
    'SpeechTokenKeyAttributes', 'DISPID_SOTs_NewEnum', 'SP_VISEME_12',
    'SRAInterpreter', 'SpeechStreamFileMode',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechVoiceStatus',
    'SPRULESTATE', 'SPPS_Verb', 'SVPOver', 'ISpeechPhraseRules',
    'DISPID_SpeechAudioBufferInfo', 'SVP_10', 'SVSFUnusedFlags',
    'DISPID_SpeechGrammarRuleState', 'ISpeechPhraseProperty',
    'SDKLCurrentConfig', 'SAFTCCITT_ALaw_44kHzStereo',
    'SVSFParseAutodetect', 'SVSFIsXML', 'SRCS_Disabled',
    'SPDATAKEYLOCATION',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_1',
    'SPEVENT', 'DISPID_SGRSTsItem', 'DISPID_SVSpeak',
    'DISPID_SRGState', 'DISPID_SLWsCount', 'SpMMAudioIn',
    'SpSharedRecognizer', 'SWPKnownWordPronounceable',
    'DISPID_SRCEAudioLevel', 'ISpeechBaseStream', 'SpeechWordType',
    'SPAS_PAUSE', 'DISPID_SRSCurrentStreamNumber', 'SSFMCreate',
    'DISPID_SGRSTWeight', 'DISPID_SGRSTText', 'ISpObjectToken',
    'SpeechRuleAttributes', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechRecoResult2',
    'SPPROPERTYINFO', 'SPSERIALIZEDPHRASE', 'SPRECOSTATE',
    'eLEXTYPE_PRIVATE18', 'SpPhraseInfoBuilder',
    'SPSMF_SAPI_PROPERTIES', 'SAFTNonStandardFormat', 'SREPrivate',
    'DISPID_SRGCommit', 'DISPID_SASetState', 'eLEXTYPE_PRIVATE6',
    'SAFTADPCM_22kHzMono', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechPhraseProperty', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRRAudio', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SVIsUISupported', 'ISpRecoGrammar',
    'Speech_Max_Word_Length', 'SPVISEMES', '_ISpeechVoiceEvents',
    'SpeechTokenValueCLSID', 'STCAll', 'SITooSlow', 'DISPID_SVResume',
    'ISpeechRecoGrammar', 'SPEI_REQUEST_UI', 'DISPID_SDKEnumKeys',
    'DISPID_SAEventHandle', 'DISPID_SVPause',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechGrammarTagDictation',
    'SPADAPTATIONRELEVANCE', 'SPAR_High', 'SPCONTEXTSTATE',
    'WAVEFORMATEX', 'Speech_Max_Pron_Length', 'SVESentenceBoundary',
    'SP_VISEME_14', 'SPEVENTENUM', 'DISPID_SRCEPhraseStart',
    'DISPID_SPIGrammarId', 'DISPID_SPIReplacements',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRsCount', 'SINoSignal', 'DISPID_SMSAMMHandle',
    'SpeechBookmarkOptions', 'SRADefaultToActive', 'DISPID_SLPsCount',
    'DISPID_SLGenerationId', 'SPWT_DISPLAY', 'DISPID_SPAs_NewEnum',
    'DISPID_SVGetAudioInputs', 'SDA_Consume_Leading_Spaces',
    'SRATopLevel', 'SGRSTTWildcard', 'DISPID_SpeechLexicon',
    'DISPID_SLPSymbolic', 'SpeechPropertyResponseSpeed',
    'DISPID_SAFGuid', 'DISPID_SOTCId', 'SPEI_END_INPUT_STREAM',
    'ISpeechLexiconPronunciations', 'SPBOOKMARKOPTIONS',
    'DISPID_SABufferInfo', 'DISPID_SRRGetXMLResult',
    'SPPS_SuppressWord', 'DISPID_SVSRunningState', 'IEnumString',
    'SAFTCCITT_uLaw_44kHzMono', 'SPRS_INACTIVE',
    'ISpeechGrammarRuleStateTransitions', 'SRADynamic',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechLexiconPronunciation',
    'DISPID_SASCurrentSeekPosition', 'SPLO_STATIC',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPIElements',
    'SpPhoneConverter', 'SpeechGrammarTagUnlimitedDictation',
    'SpObjectTokenCategory', 'DISPID_SPRsItem', 'SRTAutopause',
    'SPAR_Unknown', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISequentialStream', 'SPEI_UNDEFINED', 'SREInterference',
    'SDTLexicalForm', 'ISpeechObjectTokens', 'SVP_12',
    'DISPID_SPRuleNumberOfElements', 'SREStreamEnd',
    'DISPID_SpeechRecognizer', 'SPXMLRESULTOPTIONS',
    'SPEI_END_SR_STREAM', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRRGetXMLErrorInfo', 'SSTTDictation',
    'DISPID_SRGDictationUnload', 'DISPID_SRStatus',
    'SPEI_TTS_PRIVATE', 'IStream', 'DISPID_SGRAttributes',
    'DISPIDSPTSI', 'DISPID_SAVolume', 'DISPID_SRSSupportedLanguages',
    'DISPID_SOTCategory', 'SPSVerb', 'SBOPause',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPCLangId',
    'SPEI_MIN_SR', 'SVP_19', 'SAFT48kHz8BitStereo', 'SRAImport',
    'SPFM_OPEN_READWRITE', 'DISPID_SVSCurrentStreamNumber',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPEDisplayAttributes',
    'SPLO_DYNAMIC', 'DISPID_SVGetAudioOutputs',
    'SpeechEngineConfidence', 'ISpRecoContext',
    'SAFTGSM610_22kHzMono', 'ISpeechGrammarRule',
    'SPDKL_DefaultLocation', 'DISPID_SABufferNotifySize',
    'SPAO_RETAIN_AUDIO', 'LONG_PTR', 'SAFT16kHz16BitStereo',
    'DISPID_SRGReset', 'SPEI_WORD_BOUNDARY', 'SpeechTokenContext',
    'DISPID_SOTDisplayUI', 'UINT_PTR', 'SGLexicalNoSpecialChars',
    'eLEXTYPE_LETTERTOSOUND', 'ISpRecoCategory', 'ISpPhrase',
    'eLEXTYPE_PRIVATE13', 'STSF_CommonAppData',
    'DISPID_SREmulateRecognition', 'SpeechVisemeFeature',
    'SPBO_PAUSE', 'SPEI_PROPERTY_NUM_CHANGE', 'SpMMAudioEnum',
    'DISPID_SRRDiscardResultInfo', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SAFType', 'ISpeechMemoryStream',
    'DISPID_SpeechMemoryStream', 'eLEXTYPE_PRIVATE4',
    'SAFT44kHz8BitMono', 'ISpeechTextSelectionInformation',
    'DISPID_SOTGetDescription', 'ISpeechPhraseElements',
    'SPLEXICONTYPE', 'SPPS_Noncontent',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRCEventInterests',
    'SAFTGSM610_11kHzMono', 'DISPID_SPEEngineConfidence',
    'SRESoundEnd', 'ISpeechRecoResult',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPRuleChildren',
    'STCInprocHandler', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechObjectToken', 'SWPUnknownWordPronounceable',
    'DISPID_SABIBufferSize', 'SGDSActive', 'SVEPhoneme',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRCERecognition',
    'eLEXTYPE_RESERVED7', 'DISPID_SRAudioInput',
    'DISPID_SPELexicalForm', 'ISpeechPhraseReplacements',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRAddState', 'SDKLLocalMachine',
    'SVSFIsNotXML', 'SPCT_DICTATION',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechLexiconWords',
    'eLEXTYPE_PRIVATE19', 'ISpeechObjectToken', 'SVEEndInputStream',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechBaseStream',
    'SDTAlternates', 'SAFT16kHz16BitMono', 'ISpRecognizer3',
    'SRAONone', 'SpeechRuleState', 'DISPID_SPAStartElementInResult',
    'ISpeechRecoContext', 'SREFalseRecognition',
    'DISPID_SRGCmdSetRuleState', 'SPVPRI_NORMAL',
    'SpNullPhoneConverter', 'DISPID_SDKGetlongValue',
    'SpeechVisemeType', 'DISPIDSPRG', 'DISPID_SPRNumberOfElements',
    'DISPID_SMSGetData', 'DISPID_SVSLastResult', 'SPEI_PHRASE_START',
    'SRCS_Enabled', 'DISPID_SRGCmdSetRuleIdState', 'SVSFVoiceMask',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechLexiconWord',
    'DISPID_SLWPronunciations', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPIDSPTSI_ActiveOffset', 'SRSInactiveWithPurge',
    'SVSFPersistXML', 'SDTRule', 'DISPID_SRGCmdLoadFromMemory',
    'SSTTTextBuffer', '__MIDL_IWinTypes_0009',
    'DISPID_SRCEPropertyStringChange', 'SSFMOpenForRead',
    'SPWORDPRONUNCIATION', 'SRTEmulated', 'SREAdaptation',
    'SPSHORTCUTTYPE', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGSetWordSequenceData', 'ISpeechRecoResultTimes',
    'SAFT22kHz8BitMono', 'DISPID_SLWType', 'SAFT8kHz16BitMono',
    'DISPID_SRCERequestUI', 'DISPID_SRCEAdaptation',
    'eWORDTYPE_ADDED', 'SAFTExtendedAudioFormat', 'SGRSTTEpsilon',
    'SpeechDiscardType', 'SPSHT_Unknown', 'DISPID_SPPId',
    'DISPID_SDKGetBinaryValue', 'SPPS_RESERVED3',
    'ISpeechXMLRecoResult', 'DISPID_SVEWord', 'SPBO_AHEAD',
    'SAFT22kHz16BitStereo', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPPValue', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRClear',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechAllElements', 'SPXRO_SML', 'SPWORDPRONUNCIATIONLIST',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SWFEBitsPerSample',
    'DISPID_SpeechGrammarRule', 'DISPID_SRProfile',
    'eLEXTYPE_RESERVED8', 'DISPID_SVGetProfiles', 'SPEI_INTERFERENCE',
    'DISPID_SRGDictationLoad', 'SpeechAudioFormatGUIDWave',
    'DISPID_SOTCDefault', 'DISPID_SPPsItem',
    'DISPID_SPIAudioSizeBytes', 'SPEI_PHONEME', 'DISPID_SPPParent',
    'SpeechAudioFormatType', 'eLEXTYPE_APP',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SOTGetAttribute',
    'SpeechWordPronounceable', 'DISPID_SPRText',
    'SGDSActiveUserDelimited', 'DISPID_SLAddPronunciation',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLPType',
    'SP_VISEME_8', 'Speech_Default_Weight',
    'DISPID_SpeechRecoResult2', 'DISPID_SVSInputWordLength',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SGRsDynamic',
    'SPCT_SUB_DICTATION', 'SVP_6', 'SPAS_STOP',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_9',
    'ISpeechLexicon', 'DISPID_SRCEEndStream', 'SAFT22kHz16BitMono',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPRsCount', 'DISPID_SRRTimes', 'DISPID_SPPChildren',
    'SPAUDIOSTATE', 'DISPID_SVSInputWordPosition', 'SSTTWildcard',
    'SRTStandard', 'DISPID_SOTCSetId', 'SPRECORESULTTIMES',
    'ISpNotifyTranslator', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVSLastBookmark', 'DISPID_SPEDisplayText',
    'SpSharedRecoContext', 'ISpeechAudio', 'SVP_7',
    'SpeechTokenIdUserLexicon', 'DISPID_SMSALineId',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechVoice',
    'DISPID_SOTDataKey', 'DISPID_SRCRequestedUIType',
    'SpeechDictationTopicSpelling', 'SpStream',
    'SpeechCategoryRecoProfiles', 'SP_VISEME_19', 'SPCT_SUB_COMMAND',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SWFEChannels',
    'DISPID_SGRId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLGetWords', 'SpeechDataKeyLocation', 'SPEI_RESERVED1',
    'eLEXTYPE_RESERVED9', 'SPPS_Function', 'STCInprocServer',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRAudioInputStream',
    'SAFT32kHz8BitStereo', 'SPINTERFERENCE_TOOFAST',
    'SGRSTTTextBuffer', 'SPFM_OPEN_READONLY', 'SVP_0',
    'SGPronounciation', 'ISpAudio', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPCIdToPhone', 'SRAExport', 'SVP_8', 'SPSFunction',
    'DISPID_SVGetVoices', 'SPPS_RESERVED2', 'DISPID_SGRSRule',
    'ISpeechRecoResultDispatch', 'SPEI_SOUND_START',
    'DISPID_SVEBookmark', 'DISPIDSPTSI_SelectionLength',
    'SpeechRegistryUserRoot', 'SpeechTokenKeyUI', 'DISPID_SLWWord',
    'DISPID_SLWLangId', 'DISPID_SRGetRecognizers', 'SVEBookmark',
    'DISPID_SPERequiredConfidence', 'SPWORD', 'SPPS_LMA', 'SVP_13',
    'DISPID_SVRate', 'SPDKL_CurrentConfig', 'SPCS_DISABLED',
    'DISPID_SVEAudioLevel', 'DISPID_SPRuleId', 'SpeechCategoryVoices',
    'DISPID_SGRSTs_NewEnum', 'SPSInterjection',
    'DISPID_SRCEFalseRecognition', 'SSSPTRelativeToEnd', 'SPBO_NONE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCCmdMaxAlternates',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPRuleName', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechDisplayAttributes', 'SLTUser', 'eLEXTYPE_PRIVATE12',
    'SpLexicon', 'DISPIDSPTSI_ActiveLength', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_uLaw_11kHzMono',
    'SP_VISEME_6', 'SpeechGrammarState', 'DISPID_SOTSetId',
    'ISpPhraseAlt', 'SVSFParseMask', 'DISPID_SRCRetainedAudioFormat',
    'SPSMF_UPS', 'SPAUDIOOPTIONS', 'DISPID_SOTsItem',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPPs_NewEnum',
    'DISPID_SPEPronunciation', 'DISPID_SVVolume',
    'SPSTREAMFORMATTYPE', 'SAFT44kHz8BitStereo',
    'DISPID_SDKSetBinaryValue', 'SAFTGSM610_8kHzMono',
    'STCLocalServer', 'ISpStreamFormatConverter', 'SPPS_NotOverriden',
    'SVEPrivate', 'SPEI_RESERVED2', 'SVF_None'
]
